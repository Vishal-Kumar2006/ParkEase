...
async function handleSignUp(req, res) {
  try {
    ...
    const newUser = await User.create({
      ...
      photo: photo || "https://upload.wikimedia.org/wikipedia/commons/9/99/Sample_User_Icon.png"
    });

    console.log(newUser);

    // ✅ Store user in session
    req.session.user = { id: newUser._id, email: newUser.email, name: newUser.name, photo: newUser.photo };
...
module.exports = { handleSignUp, handleLogin, handleLogout, getCurrentUser, getParkingUser, updateUserParking };